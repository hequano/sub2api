...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	settingHandler := handler.ProvideAdminSettingHandler(settingService, emailService, turnstileService, aliyunCaptchaService, capService, opsService, paymentConfigService, paymentService, userAttributeService, notificationEmailService, totpService, userService)
